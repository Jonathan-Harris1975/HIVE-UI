...
type SelectedAction = null | "chat" | "apply_skill" | "create_skill" | "upload";
type PendingDelete =
  | { type: "selected" }
  | { type: "single"; file: FileObject };
...
function isHiveSkillsDescriptorFolder(
  lane: string,
...
function selectedSourceForFile(
  lane: string,
  file: FileObject,
): FileSourceSelection {
