        ...
        return (
          <div key={node.id}>
            <button
              ...
              className={
                "group grid w-full grid-cols-[38px_minmax(0,1fr)_auto] items-start gap-3 rounded-2xl border " +
                "border-white/8 bg-hive-surface p-4 text-left transition hover:border-cyan-300/20 " +
                "hover:bg-hive-panel"
              }
            >
