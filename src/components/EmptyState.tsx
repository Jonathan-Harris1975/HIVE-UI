    ...
    <div className="rounded-3xl border border-dashed border-white/10 bg-white/[0.018] px-5 py-10 text-center">
      ...
      {action && (
        <button
          ...
          className="mt-5 inline-flex min-h-11 items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-300/8 px-4 text-sm font-medium text-cyan-100 transition hover:bg-cyan-300/12"
        >
          {action.label}
        </button>
      )}
